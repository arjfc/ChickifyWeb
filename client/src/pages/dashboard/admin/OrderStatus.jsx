    ...
    <div className="flex flex-col gap-5">
      ...
      <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-4">
        <div className="flex flex-wrap gap-3">
          ...
          {/* Options icon was here, removed alert */}
        </div>

        {/* Action buttons */}
        <div className="flex gap-3 sm:gap-5 items-center">
          <div className="bg-gray-500 text-white font-medium rounded-lg px-3 py-1.5 sm:px-5 sm:py-2 text-sm sm:text-base cursor-pointer hover:opacity-90">
            Cancel
          </div>
          <div
          ...
          <div className="bg-primaryYellow text-white font-medium rounded-lg px-3 py-1.5 sm:px-5 sm:py-2 text-sm sm:text-base cursor-pointer hover:opacity-90">
            Mark as Complete
          </div>
        </div>
      </div>
