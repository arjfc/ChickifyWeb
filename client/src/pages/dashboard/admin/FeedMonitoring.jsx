...
//   return (
//     <div className="rounded-lg bg-gradient-to-r from-yellow-50 to-orange-50 border-l-4 border-[#F6C32B] p-4 shadow-sm">
...
//   const handleConfirmAllocate = async ({ purchaseId, allocations /*, totalKg */ }) => {
//     try {
//       setSubmitting(true);
