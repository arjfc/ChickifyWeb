...
import NoAccess from "../pages/NoAccess"; // import the NoAccess page
...
export default function DashboardLayout() {
  ...
  const pageTitles = {
    ...
    "/admin/suspicious-activities": "Suspicious Activities",
          ...
          <header className="flex flex-row mb-6 pb-3 w-full gap-4 items-center">
            ...
            <div className="relative flex-grow">
              ...
              <input
                type="text"
                placeholder="Search..."
                className="w-full border border-gray-200 rounded-full bg-gray-50 pl-12 pr-12 py-3 
                  shadow-sm focus:outline-none focus:ring-2 focus:ring-primaryYellow focus:border-primaryYellow transition"
              />
          ...
          <div className="flex flex-row justify-between items-center">
            ...
            <div className="flex flex-col leading-tight items-end">
              {location.pathname.includes("edit-users") ? (
                <button
                  className="cursor-pointer text-base rounded-lg text-white font-bold shadow-md bg-primaryYellow px-4 py-3"
                  onClick={() => {}}
                >
